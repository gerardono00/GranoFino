...
router.post("/", auth_1.auth, async (req, res) => {
    ...
    try {
        ...
        const result = await db_1.default.query("INSERT INTO orders (user_id, total, payment_method, payment_status) VALUES ($1, $2, $3, $4) RETURNING id", [req.user.id, total, payment_method, "pagado"]);
...
router.get("/", auth_1.auth, admin_middleware_1.default, async (_req, res) => {
    try {
